        ...
        <div class="part-item" ${isMe ? 'style="background:rgba(59,130,246,0.05);border-radius:8px;padding:10px 8px;"' : ''}>
          ...
          <div class="part-info">
            <div class="part-name">
              ...
              ${isCreator ? '<span style="font-size:9px;font-weight:700;color:var(--text-muted);background:var(--bg-input);padding:1px 5px;border-radius:999px;margin-left:5px;">Creatore</span>' : ''}
            </div>
            <div class="part-sub">
